...
<body>
    ...
    if (isset($_POST) && !empty($_POST)) {
        ...
        $update->execute(array(
            ...
            $msg = "Lien pour réinitialiser votre mot de passe : http://localhost/cours_php/l0gan123456.github.io/correction_connexion/reset.php?id=" . $select[0]['id'] . "&token=$token";
